...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      ...
      <DialogPrimitive.Close className="focus:ring-primary absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none hover:bg-accent">
        <Icon type="x" size="xs" className="text-foreground" />
