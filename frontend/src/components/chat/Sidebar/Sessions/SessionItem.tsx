...
const SessionItem = ({
  ...
  const { sessionsData, setSessionsData, mode, getActiveConnection } = useStore()
  ...
  const handleDeleteSession = async () => {
    ...
    try {
      ...
      const endpoint = activeConnection?.endpoint || ''
    ...
    <>
      ...
      >
        <div className="flex flex-col gap-1">
          <h4
            className={cn('text-sm font-medium text-foreground', isSelected && 'text-primary')}
          >
